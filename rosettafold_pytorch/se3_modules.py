#
# https://raw.githubusercontent.com/RosettaCommons/RoseTTAFold/main/network/SE3_network.py
#
import torch
...
class TFN(nn.Module):
    ...
    def _build_gcn(self, fibers):
        ...
        for i in range(self.num_layers - 1):
            block0.append(
                GConvSE3(
                    fin, fibers["mid"], self_interaction=self.use_self, edge_dim=self.edge_dim
                )
            )
